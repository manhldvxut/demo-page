			...
			<div class="container">
				<div class="max-entry">
					...
					<div class="logo-part text-center">
						<ul class="list-inline d-flex w-100">
							<li class="list-inline-item"><img src="../images/recruit/part-2.png" class="img-fluid w-100" srcset="../images/recruit/part-2.png, ../images/recruit/part-2@2x.png 2x" alt=""></li>
							<li class="list-inline-item"><img src="../images/recruit/part-3.png" class="img-fluid w-100" srcset="../images/recruit/part-3.png, ../images/recruit/part-3@2x.png 2x" alt=""></li>
							<li class="list-inline-item"><img src="../images/recruit/part-4.png" class="img-fluid w-100" srcset="../images/recruit/part-4.png, ../images/recruit/part-4@2x.png 2x" alt=""></li>
						</ul>
					</div>
					...
					<div class="form-contact">
						<form action="index-08.php">
							<div class="list-item-form">
								<div class="item">
									<div class="left">希望雇用形態 <span>必須</span></div>
									<div class="right">
										<ul>
											<li>
												<input type="radio" name="form-contact" id="ct-1">
												<label for="ct-1">正社員</label>
											</li>
											<li>
												<input type="radio" name="form-contact" checked id="ct-2">
												<label for="ct-2">アルバイト</label>
											</li>
										</ul>
									</div>
								</div>
								<div class="item">
									<div class="left">応募する求人内容 <span>必須</span></div>
									<div class="right">
										<div class="choose-select">
											...
											<p>※現在募集中の求人内容についてはこちらからご確認ください。</p>
										</div>
									</div>
								</div>
								<div class="item">
								...
								<!-- <div class="item">
									...
									<div class="right">
										<ul class="list-inline d-block">
											<li class="list-inline-item">ファイルが選択されていません</li>
											<li class="list-inline-item"><span>ファイルを追加する</span></li>
										</ul>
									</div>
								</div>
								<div class="item">
