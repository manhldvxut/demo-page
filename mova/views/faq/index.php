...
<main>
	<section class="hea-top">
		...
		<div class="container news">
			<h1 class="big-line">Q&A <span class="jp">よくあるご質問</span></h1>
		</div>
                            ...
                            <div class="faq" id="accordion">
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-4">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-4" data-aria-expanded="false" data-aria-controls="faqCollapse-4" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-5">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-5" data-aria-expanded="false" data-aria-controls="faqCollapse-5" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-6">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-6" data-aria-expanded="false" data-aria-controls="faqCollapse-6" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-7">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-7" data-aria-expanded="false" data-aria-controls="faqCollapse-7" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-8">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-8" data-aria-expanded="false" data-aria-controls="faqCollapse-8" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="faqHeading-8">
                                        <div class="mb-0">
                                            <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-9" data-aria-expanded="false" data-aria-controls="faqCollapse-9" aria-expanded="false">
                                                アコーディオン初期表示です。
                                            </h5>
                                        </div>
                                    </div>
