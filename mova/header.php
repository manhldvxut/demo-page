...
<head>
    ...
    <title>Mova</title>
    <!--link css-->
    <link rel="stylesheet" type="text/css" title="" href="<?php echo DOMAIN; ?>/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" title="" href="<?php echo DOMAIN; ?>/css/animate.min.css">
    ...
    <link rel="stylesheet" type="text/css" title="" href="<?php echo DOMAIN; ?>/css/style.css">
    <link rel="stylesheet" type="text/css" title="" href="<?php echo DOMAIN; ?>/css/responsive.css">
...
<body> 
    <header>
        <div class="header-menu"> 
            <div class="menu">
                <h1 class="logo"> <a href="<?php echo DOMAIN; ?>">
                ...
                <ul>
                    <li>
                        <a href="<?php echo DOMAIN; ?>/about/" class="">サービスについて</a> 
                        <i class="d-none"></i>
                    </li> <!-- end sub1 -->
                    <li>
                        <a href="<?php echo DOMAIN; ?>/sticker/" class="">ステッカーを探す</a>
                        <i class="d-none"></i>
                    </li><!-- end sub2 -->
                    <li>
                        <a href="<?php echo DOMAIN; ?>/guide/">ご利用ガイド</a><i class="d-none"> </i>
                    </li><!-- end sub3 -->
                    <li>
                        <a href="<?php echo DOMAIN; ?>/faq/">よくあるご質問</a>
                        <i class="d-none"></i>
                    </li><!-- end sub4 -->
                                ...
                                <li>
                                    <div class="submenu-info">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="/guide">お申し込み方法</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                            <li>
                                                <a href="/stecker">ステッカーの仕様</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                            <li>
                                                <a href="/ads">広告のお申込み</a>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><defs><style>.a{fill:#dc000c;}.b{fill:#fff;}</style></defs><g transform="translate(-386 -297)"><circle class="a" cx="9.5" cy="9.5" r="9.5" transform="translate(386 297)"/><path class="b" d="M932.82,244.681c1.294.689,1.294,1.817,0,2.506l-3.467,1.847c-1.294.689-2.353.134-2.353-1.234v-3.73c0-1.368,1.059-1.923,2.353-1.234Z" transform="translate(-534.395 60.204)"/></g></svg></span>
                                            </li>
                                        </ul>
                                    </div>
